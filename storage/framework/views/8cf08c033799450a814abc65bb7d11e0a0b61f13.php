...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">CompactLab Restaurant Managment System</a>
   ...
   <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <!-- Core plugin JavaScript-->
          ...
          <script type="text/javascript" src="<?php echo e(asset('js/jquery.easing.js')); ?>"></script>
        <!-- Page level plugin JavaScript-->
          ...
          <script type="text/javascript" src="<?php echo e(asset('js/sb-admin.js')); ?>"></script>

        <!-- Custom scripts for this page-->

          <script type="text/javascript" src="<?php echo e(asset('js/sb-admin-datatables.js')); ?>"></script>


          <script type="text/javascript" src="<?php echo e(asset('js/sb-admin-charts.js')); ?>"></script>
